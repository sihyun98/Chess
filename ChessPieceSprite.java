...
//Chess piece image를 가져오는데에 사용
//Chess pieces의 이미지를 관리하기 위한 클래스
//클래스를 사용하기 위해서는 getInstance()로 불러움
public class ChessPieceSprite
{
	...
	{
		//4 different colors of chess pieces
	 ...
	 */
	//원하는 색의 chess piece의 BufferedImage를 반환
	//원하는 색은 ChessPieceSpriteType에 있음
...
//BufferedImage img = ChessPieceSprite.getInstance().getChessPiece(ChessPieceSpriteType.BLACK_BISHOP);
//검정색의 비숍을 img변수인 BufferedImage에 저장